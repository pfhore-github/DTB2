...
public:
    ...
    enum {
        MENU_View = wxID_HIGHEST + 1002,
        MENU_View2 = wxID_HIGHEST + 1003
    };
    // end wxGlade
...
public:
    ...
    virtual void OnView(wxCommandEvent &event); // wxGlade: <event_handler>
    virtual void OnView2(wxCommandEvent &event); // wxGlade: <event_handler>
